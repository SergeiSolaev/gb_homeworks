    ...
    <div class="project center">
        ...
        <div class="project__items">
            <div class="project__item" v-for="project in projects" :key="project.id">
                ...
                <img @dblclick="addFavorite(project.id)" :src=project.img_item class="project__img">
                ...
                <div class="products__item__content">
                    ...
                    <router-link class="products__item__content__button" :to="`/project-details/${project.id}`">
...
<script>
    ...
    export default {
        ...
        // Создаём отдельный массив для сортировки
        mounted() {
        ...
        methods: {
            ...
            createTags() {
                this.tags = [];
                this.projectsStore.forEach(project => {
                    if (!this.tags.includes(project.tag)) {
                        this.tags.push(project.tag);
                    }
                });
            },
            // Сортируем проекты по категориям
            sortByTag(tag) {
