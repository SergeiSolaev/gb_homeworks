    ...
    <div class="top">
        ...
        <div class="promo-wrapper center">
            <div class="promo">
                <div class="promo__info">
                    ...
                    <a class="promo__info__button" href="#">
                        <p>Начать</p>
        ...
        <div class="articles center">
            <div class="articles__info">
                <h1 class="articles__info__title">
                    Cтатьи & <br>Новости
                </h1>
                <p class="articles__info__text">
                    Хорошо известно, что читатель будет отвлекаться на читабельный контент страницы
                </p>
            </div>
            <div class="articles__items">
                <div class="articles__items__item">
                    <div class="articles__items__item__img-wrapper">
                        <img class="articles__items__item__img" src="@/assets/img/articles/img1.jpeg" alt="">
                        <div class="articles__items__item__img__label">
                            Дизайн кухни
                        </div>
                    </div>
                    <div class="articles__items__item__title">Создадим лучший макет перепланировки</div>
                    <div class="articles__items__item__date">
                        26 Декабрь,2022
                        <a class="articles__items__item__date__button backgroundCreme" href="#">
                            <svg width="10.004044" height="20.008179" viewBox="0 0 10.004 20.0082" fill="none"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <desc>
                                    Created with Pixso.
                ...
                <div class="articles__items__item backgroundCreme">
                    <div class="articles__items__item__img-wrapper">
                        <img class="articles__items__item__img" src="@/assets/img/articles/img2.jpeg" alt="">
                        <div class="articles__items__item__img__label">
                            Дизайн для жизни
                        </div>
                    </div>
                    <div class="articles__items__item__title">Лучшие интерьерные идеи по низкой цене</div>
                    <div class="articles__items__item__date">
                        22 Декабрь,2022
                        <a class="articles__items__item__date__button backgroundWhite" href="#">
                            <svg width="10.004044" height="20.008179" viewBox="0 0 10.004 20.0082" fill="none"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <desc>
                                    Created with Pixso.
                ...
                <div class="articles__items__item">
                    <div class="articles__items__item__img-wrapper">
                        <img class="articles__items__item__img" src="@/assets/img/articles/img3.jpeg" alt="">
                        <div class="articles__items__item__img__label">
                            Дизайн интерьера
                        </div>
                    </div>
                    <div class="articles__items__item__title">Лучшие интерьерные решения для офисов </div>
                    <div class="articles__items__item__date">
                        26 Декабрь,2022
                        <a class="articles__items__item__date__button backgroundCreme" href="#">
                            <svg width="10.004044" height="20.008179" viewBox="0 0 10.004 20.0082" fill="none"
...
.promo {
    ...
    width: 1200px;
    height: 758px;
    background-image: url(@/assets/img/promo_banner.jpeg);
...
.products {
    ...
    &__item {
        ...
        &__img-1 {
            width: 548px;
            height: 525px;
            background-image: url(@/assets/img/products/top_products-1.jpeg);
        ...
        &__img-2 {
            width: 548px;
            height: 525px;
            background-image: url(@/assets/img/products/top_products-2.jpeg);
            background-position: 80% 55%;
        ...
        &__img-3 {
            width: 548px;
            height: 525px;
            background-image: url(@/assets/img/products/top_products-3.jpeg);
            background-position: 80% 55%;
        ...
        &__img-4 {
            width: 548px;
            height: 525px;
            background-image: url(@/assets/img/products/top_products-4.jpeg);
            background-position: 80% 55%;
...
.blogDetailsBanner {
    background-image: url(@/assets/img/blog_details_banner.jpeg);
}

.blogBanner {
    background-image: url(@/assets/img/blog_banner.jpeg);
}
</style>